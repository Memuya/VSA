				...
				<?php if($_executives->getCount() != 0): ?>
					...
					<?php foreach($executives as $executive): ?>
						...
						<tr>
							...
							<td><a href="<?=PATH?>cp/edit-executive?id=<?=$executive->id;?>" class="btn"><i class="fa fa-pencil-square-o"></i></a></td>
							<td><a href="#" data-link="<?=PATH?>cp/delete-executive?id=<?=$executive->id;?>" class="delete-btn btn"><i class="fa fa-times"></i></a></td>
						</tr>
