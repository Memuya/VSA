...
//if the search variable is passed through the url, we call the search method
	...
	<div class="outer-wrapper white">
		<div class="inner-wrapper">
			...
			<section class="right-main">
				...
				<form id="form">
					<div class="field">
						<input type="text" name="search" id="search" placeholder="Search Username or #ID" style="width: 200px;">
					</div>
				</form>
